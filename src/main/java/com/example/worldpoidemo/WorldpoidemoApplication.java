package com.example.worldpoidemo;
...
import com.example.worldpoidemo.config.FacesViewScope;

@SpringBootApplication
public class WorldpoidemoApplication extends SpringBootServletInitializer {

	public static void main(String[] args) {
		SpringApplication.run(WorldpoidemoApplication.class, args);
	}
	
	@Override
    protected SpringApplicationBuilder configure(SpringApplicationBuilder application) {
        return application.sources(WorldpoidemoApplication.class);
    }
